...
class SampleDataset:
    def __init__(self, args, mode="both",sampling='random'):
        ...
        self.path_to_annotations ='/media/lgz/Scipio/lgz/Bi-SCC/MM2021-CO2-Net5_split/Thumos14reduced-Annotations/' #os.path.join(args.path_dataset,self.dataset_name + "-Annotations/")
    ...
    def load_data(self, n_similar=0, is_training=True, similar_size=2):
        if is_training:
            ...
            if self.mode == "rgb":
                ...
                feat = feat[..., self.feature_size :]
            return feat, labels,rand_sampleid,vid_name
