...
parser.add_argument('--path-dataset', type=str, default='./Thumos14reduced', help='the path of data feature')
...
parser.add_argument('--use-model0',type=str,help='model used to train the network0')
parser.add_argument('--use-model1',type=str,help='model used to train the network1')
parser.add_argument('--use-model2',type=str,help='model used to train the network2')
